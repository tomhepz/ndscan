...
fragments within the new prepared runtime.
...
This matches the structure of the current prepared runtime well, and avoids recreating
...
The rest of the prepared runtime should stay the same:
...
This is a good match for the current batch-oriented prepared runtime.
