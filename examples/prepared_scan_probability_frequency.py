"""Prepared-runtime repeat-until-probability-precision example.

This example combines several of the new prepared-runtime ideas in one place:
...
PreparedScanProbabilityFrequency = make_fragment_prepared_scan_exp(
    FrequencyFromProbabilityFragment,
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "prepared_scan_probability_frequency"}
    ),
)
