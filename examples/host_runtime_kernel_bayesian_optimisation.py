"""Host-runtime Bayesian optimisation example with a resident kernel objective.
...
try:
    ...
    raise ImportError(
        "host_runtime_kernel_bayesian_optimisation requires the optional Bayesian "
...
def make_request(
    ...
    *,
    ...
    return ScanRequest(
        ...
        metadata={"demo_name": "host_runtime_kernel_bayesian_optimisation"},
    )
