"""Plot the synthetic BO surface used by host_runtime_bayesian_optimisation.py.

Usage:

    python examples/plot_host_runtime_bo_surface.py
"""
...
def main() -> None:
    ...
    ax.set_title("Host Runtime BO Example Surface")
    ax.set_xlabel("x")
    ax.set_ylabel("y")
    ax.set_zlabel("cost")
