...
__all__ = [
    ...
    "PreparedScanThreeImageRearrangement",
    "PreparedScanThreeImageRearrangementDashboard",
]
...
def build_three_image_rearrangement_statistics_request(
    ...
    return ScanRequest.single(
        metadata={"demo_name": "prepared_scan_three_image_rearrangement"},
    )


PreparedScanThreeImageRearrangement = make_fragment_prepared_scan_exp(
    ThreeImageRearrangementStatisticsFragment,
    build_three_image_rearrangement_statistics_request,
)


PreparedScanThreeImageRearrangementDashboard = make_fragment_prepared_dashboard_scan_exp(
    ThreeImageRearrangementDashboardFragment
)
