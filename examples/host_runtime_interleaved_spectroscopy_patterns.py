"""Interleaved spectroscopy patterns for the host runtime.
...
HostRuntimeInterleavedSpectroscopy = make_fragment_prepared_scan_exp(
    InterleavedSpectroscopyFragment,
    build_interleaved_demo_request,
)
...
HostRuntimeChunkedInterleavedSpectroscopy = make_fragment_prepared_scan_exp(
    ChunkedInterleavedSpectroscopyFragment,
    build_chunked_demo_request,
)
...
HostRuntimeInterleavedSpectroscopySubscan = make_fragment_prepared_scan_exp(
    InterleavedSpectroscopySubscanRootFragment,
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "host_runtime_interleaved_spectroscopy_subscan"}
    ),
)
