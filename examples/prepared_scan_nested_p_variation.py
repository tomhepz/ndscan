"""Nested prepared-runtime scan example.

This is the prepared-runtime rewrite of the classic "subscan inside a subscan" shape.
...
class HowDoesPVaryFragment(ExpFragment):
    ...
    ``SubscanExpFragment`` usage style while exercising the new prepared-runtime recursion
    path directly.
    """
...
PreparedScanHowDoesPVary = make_fragment_prepared_scan_exp(
    ...
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "prepared_scan_nested_p_variation"}
    ),
)
