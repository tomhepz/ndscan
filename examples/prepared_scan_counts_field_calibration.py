...
__all__ = [
    ...
    "PreparedScanCountsShotChunkTimeScan",
    "PreparedScanCountsFrequencyCalibration",
    "PreparedScanCountsFieldCalibration",
]
...
def build_time_scan_request(fragment: CountsShotChunkFragment) -> ScanRequest:
    ...
    return ScanRequest.cartesian(
        ...
        metadata={"demo_name": "prepared_scan_counts_shot_chunk_time_scan"},
...
PreparedScanCountsShotChunkTimeScan = make_fragment_prepared_scan_exp(
    CountsShotChunkFragment,
    build_time_scan_request,
)


PreparedScanCountsFrequencyCalibration = make_fragment_prepared_scan_exp(
    FrequencyCalibrationAtFieldFragment,
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "prepared_scan_counts_frequency_calibration"}
    ),
)


PreparedScanCountsFieldCalibration = make_fragment_prepared_scan_exp(
    CountsFieldCalibrationRootFragment,
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "prepared_scan_counts_field_calibration"}
    ),
)
