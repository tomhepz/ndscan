"""Examples of runtime parameter mappings in the new host-only runtime.
...
Both routes end up in the same host-runtime execution path. The runtime installs any
...
HostRuntimeMappedLogicalAxis = make_fragment_prepared_scan_exp(
...
HostRuntimeWrapperRebind = make_fragment_prepared_scan_exp(
