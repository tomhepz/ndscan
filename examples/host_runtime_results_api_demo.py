"""Host-runtime example for typical offline ``ndscan.results`` workflows.
...
def build_results_api_demo_request(fragment: ResultsApiDemoFragment) -> ScanRequest:
    ...
    request = ScanRequest.cartesian(
        ...
        metadata={
            "demo_name": "host_runtime_results_api_demo",
...
HostRuntimeResultsApiDemo = make_fragment_prepared_scan_exp(
