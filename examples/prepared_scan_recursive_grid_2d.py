"""Prepared-runtime 2D recursive-refinement grid example.
...
PreparedScanRecursiveGrid2D = make_fragment_prepared_scan_exp(
    BowlSurfaceFragment,
    lambda fragment: ScanRequest(
        ...
        metadata={"demo_name": "prepared_scan_recursive_grid_2d"},
    ),
)
