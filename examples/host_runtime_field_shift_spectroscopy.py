"""Nested host-runtime spectroscopy example with repeated Bernoulli shots.
...
HostRuntimeFieldShiftSpectroscopy = make_fragment_prepared_scan_exp(
    FieldShiftDemoRootFragment,
    lambda fragment: ScanRequest.single(
        metadata={"demo_name": "host_runtime_field_shift_spectroscopy"}
    ),
)
