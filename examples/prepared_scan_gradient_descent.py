"""Prepared-runtime gradient-descent example.

This example shows the first adaptive point policy in the new prepared runtime:
...
PreparedScanGradientDescent = make_fragment_prepared_scan_exp(
    ...
    lambda fragment: ScanRequest(
        ...
        metadata={"demo_name": "prepared_scan_gradient_descent"},
    ),
)
