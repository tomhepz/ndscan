...
These are the kernel-capable counterparts to ``prepared_scan_parameter_mapping.py``.
...
PreparedScanKernelMappedLogicalAxis = make_fragment_prepared_scan_exp(
...
PreparedScanKernelMappedParamAxis = make_fragment_prepared_scan_exp(
...
PreparedScanKernelWrapperRebind = make_fragment_prepared_scan_exp(
