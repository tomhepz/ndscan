"""Prepared-runtime example showing multiple child segments for one parent point.
...
PreparedScanReusedChildSegments = make_fragment_prepared_scan_exp(
    ReusedChildSegmentsParentFragment,
    lambda fragment: ScanRequest.explicit(
        [fragment.outer],
        [[10.0], [20.0], [30.0]],
        metadata={"demo_name": "prepared_scan_reused_child_segments"},
    ),
)
