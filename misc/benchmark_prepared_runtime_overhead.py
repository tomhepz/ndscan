...
Run from the repository root, for example:
    ...
    /home/lab/artiq-files/install/ndscan/.venv/bin/python \
        misc/benchmark_prepared_scan_overhead.py --points 2000 --repeats 5

To add the hardware-backed row:

    ARTIQ_ROOT=/home/lab/artiq-files/dnamic-lab \
    /home/lab/artiq-files/install/ndscan/.venv/bin/python \
        misc/benchmark_prepared_scan_overhead.py --real-core --real-core-points 200

To also benchmark the nested TTL example:

    ARTIQ_ROOT=/home/lab/artiq-files/dnamic-lab \
    /home/lab/artiq-files/install/ndscan/.venv/bin/python \
        misc/benchmark_prepared_scan_overhead.py --nested-ttl

To benchmark a nested kernel that waits a known duration before returning:

    ARTIQ_ROOT=/home/lab/artiq-files/dnamic-lab \
    /home/lab/artiq-files/install/ndscan/.venv/bin/python \
        misc/benchmark_prepared_scan_overhead.py --nested-wait --nested-wait-us 5000

For host call attribution:

    /home/lab/artiq-files/install/ndscan/.venv/bin/python \
        misc/benchmark_prepared_scan_overhead.py --profile /tmp/ndscan_bench.prof
...
def _make_nested_wait_result(
    *,
    ...
    from examples import prepared_scan_kernel_nested_wait as wait_example
