# Host Runtime: Current Design

This document describes the current implemented state of the new host-only scan
...
The host runtime now has one explicit batch boundary. For each completed batch, the
